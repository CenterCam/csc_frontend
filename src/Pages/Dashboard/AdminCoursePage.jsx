    ...
    <div>
        ...
        <div className='w-full flex flex-col justify-center items-center'>
            <div className='flex justify-between gap-6 my-3 p-3 lg:w-1/2'>
                ...
                <Link to={"/dashboard/course/create"} className='text-white font-medium text-sm bg-green-500 py-1 px-4 rounded-full'>Create User</Link>
            </div>
                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody className='text-black font-medium'>
                            <tr className="odd:bg-white even:bg-gray-50 border-b ">
                                ...
                                <Link to={`/dashboard/course/update/${id}`} >
