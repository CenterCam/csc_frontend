...
export default function CourseUpdateForm() {
    ...
    const [description, setDescription] = useState('prapared for exam');
    const [type, setType] = useState('Free');
    const [duration, setDuration] = useState('90');
    const [cost, setCost] = useState(100); // Assuming cost is a number
    const [discount, setDiscount] = useState(100); // Assuming discount is a number
    const [price, setPrice] = useState(0); // Assuming price is a number
    const [author, setAuthor] = useState('Reach');
    const [imageLink, setImageLink] = useState('img.png');
    ...
    <div>
        ...
        <div className='p-3 w-full flex justify-center items-center'>
            <div className=" w-full md:w-1/2 ">
                <p className="my-3 font-bold text-black text-lg" >Update Course</p>
