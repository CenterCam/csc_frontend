...
export default function Signup() {
  return (
    ...
    <div className='w-96 p-6 shadow-lg rounded-lg bg-white xl:w-1/3'>
        ...
        <div>
            <label className='text-sm my-2 font-medium'>Name</label>
        ...
        <div className='mt-3'>
            <label className='text-sm my-2 font-medium'>Confirm Password</label>
            <input type="password" className='border-2 h-12 rounded-lg w-full p-3' />
        </div>
        <div className='mt-6 flex justify-between items-center'>
            <a href="/signin" className='underline text-gray-500'>Already have an account ?</a>
            <button className='py-2 px-4 rounded-lg bg-slate-900 text-white'>Sign Up</button>
        </div>
    </div>
</div>
  )
